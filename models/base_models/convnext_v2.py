...
class ConvNeXtV2(nn.Module):
    ...
    def __init__(
        ...
        # ImageNet-1k normalization statistics
        self.mean = nn.Parameter(torch.tensor([0.485, 0.456, 0.406]).view(3, 1, 1))
        self.std = nn.Parameter(torch.tensor([0.229, 0.224, 0.225]).view(3, 1, 1))

        # Stem and three intermediate downsampling conv layers
        self.depths = depths
